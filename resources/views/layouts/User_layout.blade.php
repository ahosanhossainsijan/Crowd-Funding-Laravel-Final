...
<div class="wrapper">
    ...
    <ul class="list-unstyled components">
            <li>
                    <a href="{{route('user.index')}}"><i class="fa fa-tachometer"></i>Dashboard</a>
            </li>
            ...
            <li>
                    <a href="{{route('user.create')}}"><i class="fa fa-plus"></i><span>Create New Campaign</span></a>
            </li> 
            
            <li>
                    <a href="{{route('user.donationlist')}}"><i class="fa fa-user"></i><span>Donations</span></a>
            </li>
            ...
            <li class="">
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmen">
                            <li>
                                    <a href="{{route('user.myCampaign')}}"><i class="fa fa-history"></i>My Campaings</a>
                            </li>
            
                            <li>
                                    <a href="{{route('user.campaignslist')}}"><i class="fa fa-list-alt"></i>Running Campaings</a>
                            </li>
                    </ul>
            </li>

            <li>
                    <a href="{{route('user.usersproblems')}}"><i class="fa fa-phone"></i>Contact Admin</a>
            </li>
