    ...
    <div class="row">
        ...
        <div class="col-md-8 box">
            ...
            <div class="form-group">
                <a href="<?php echo e(route('user.campaignslist')); ?>" class="btn btn-warning">Cancel</a>
                <a href="<?php echo e(route('user.reportcampaign')); ?>" class="btn btn-danger">Report</a>
...
<?php echo $__env->make('layouts.User_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Study\9th SEMESTER\APWT\Final Project\project  demo\laratest\resources\views/user/campaignedit.blade.php ENDPATH**/ ?>