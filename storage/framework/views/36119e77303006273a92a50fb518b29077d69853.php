        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 footer-box">
                    ...
                    <p><i class="fa fa-envelope-o "></i> crowdfunding@gmail.com</p>
                </div>
                <div class="col-md-4 footer-box">
            ...
            <hr>
            <p class="copyright">Team Crowd Funding</p>
        </div>
    </section>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home_navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Study\9th SEMESTER\APWT\Final Project\project  demo\laratest\resources\views/home/index.blade.php ENDPATH**/ ?>