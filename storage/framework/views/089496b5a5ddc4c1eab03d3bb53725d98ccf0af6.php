	...
	<div class="container">
		...
		<form name="myForm" action="" method="POST">
			...
			<div class="col-lg-8 m-auto d-block">
				...
				<div class="form-group">
				Forgot password?? <a href="<?php echo e(route('login.forgotpassword')); ?>">Click here</a>
				</div>
				<div class="form-group">
...
</script><?php /**PATH E:\Study\9th SEMESTER\APWT\APWT LAB\learning laravel APWT A\project\laratest\resources\views/login/index.blade.php ENDPATH**/ ?>