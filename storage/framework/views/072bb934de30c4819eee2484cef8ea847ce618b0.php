            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ml-auto" align="right">
                ...
                <li class="nav-item">
                 ...
                 <?php if(session('utype') == 0 && session()->has('utype')): ?>
                  <li class = "nav-item">
                    <a class="nav-link" href="<?php echo e(route('admin.index')); ?>">Dashboard</a>
                  </li>
                <?php elseif(session('utype') != 0): ?>
                  <li class = "nav-item">
...
</html><?php /**PATH E:\Study\9th SEMESTER\APWT\APWT LAB\learning laravel APWT A\project\laratest\resources\views/layouts/home_navbar.blade.php ENDPATH**/ ?>